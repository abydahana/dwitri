	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				<form action="<?php echo current_url(); ?>" method="post" class="form-horizontal submitForm" data-save="<?php echo phrase('save'); ?>" data-saving="<?php echo phrase('saving'); ?>" data-alert="<?php echo phrase('unable_to_add_page'); ?>">
					<?php if($this->input->is_ajax_request() && isset($modal)) { ?>
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
						<h3><i class="fa fa-plus"></i> &nbsp; <?php echo phrase('add_page'); ?></h3>
					</div>
					<?php } ?>
					...
					<div class="modal-body">
									...
									<div class="col-sm-12">
										<select name="language" class="form-control">
											...
											?>
												...
												<option value="<?php echo $field;?>"<?php if(set_value('content') == $field) echo ' selected'; ?>><?php echo ucwords($field);?></option>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" name="pageTitle" class="form-control input-lg" value="<?php echo htmlspecialchars(set_value('pageTitle')); ?>" placeholder="<?php echo phrase('page_title'); ?>" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-12">
								<textarea name="content" class="redactor form-control" placeholder="<?php echo phrase('write_page_content_here'); ?>"><?php echo set_value('content'); ?></textarea>
							</div>
						</div>
						<div class="form-group">

			...
			<div class="col-md-7 sticky">
				<div class="row grid">
					...
					<?php
							...
							foreach($friends as $id)
							{
								echo '
									<div class="col-md-6 col-sm-6 grid-item">
										' . getUserDetails(($id['fromID'] != $page['userID'] ? $id['fromID'] : $id['toID'])) . '
									</div>
								';
							}
						}
						...
						{
							echo '<div class="col-sm-12 text-center"><div class="alert alert-danger"><h4>' . $page['full_name'] . ' ' . phrase('has_no_friend') . '</h4></div></div>';
						}
					?>
				...
				<div class="row">
					<div class="col-sm-12 text-center">
						...
						<?php echo generatePagination('friends', null, $page['userID'], null, $limit, $offset); ?>
